<template>
  <div class="container">
    ...
    <div class="demo">
      <score-star :custom-class="'testclass'" :width="width" :height="height" :score="score" :UseHalfStar="UseHalfStar" :halfStarImg="halfStarImg" :fullStarImg="fullStarImg" :emptyStarImg="emptyStarImg" @tapstar="clickstar">
      </score-star>
    </div>
