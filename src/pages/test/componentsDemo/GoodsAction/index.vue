<template>
  <div class="container">
    ...
    <div class="goods-action-box">
      ...
      <van-goods-action>
        <van-goods-action-icon text="客服1"
                               @click="onClickIcon"
                               icon="https://cdn.huibaoming.com/haivit/public/image/20181026120910_500/活动订单.png">
          >
        ...
        <van-goods-action-button text="立即购买2"
                                 type="primary" />
      </van-goods-action>
    </div>
    <div class="goods-action-box">
      ...
      <van-goods-action>
        ...
        <van-goods-action-icon text="客服2"
                               @click="onClickIcon"
                               info="s1"
                               icon="https://cdn.huibaoming.com/haivit/public/image/20181026120910_500/活动订单.png">
        </van-goods-action-icon>
    ...
    <div class="info">
      ...
      <div class="fsp14 fc-grey">GoodsActionIcon API</div>
      <apiTable :tabledata="table_api_icon"></apiTable>

      <div class="fsp14 fc-grey">GoodsActionIcon Slot</div>
      <apiTable :tabledata="table_slot"></apiTable>

      <div class="fsp14 fc-grey">GoodsActionButton API</div>
      <apiTable :tabledata="table_api_button"></apiTable>
